						...
						$('#crudForm').ajaxSubmit({
							...
							success: function(result){
								...
								{	
									if(save_and_close)
									{
                                                                                //Changed by Wes Stephens (wstephens)
                                                                                //sends back to current place in hierarchy after add
										//window.location = data.success_list_url;
                                                                            if ( $('#crudForm').length ){
                                                                                ...
                                                                                if(type == 'connection'){
                                                                                    if(id == 'insert'){
                                                                                        id = $('#field-connection_id').attr('value');
                                                                                        window.location = base_url + 'inv/menu?type=' + type + 
                                                                                        '&id=' + id;                                                                                        
                                                                                    }
                                                                                }
